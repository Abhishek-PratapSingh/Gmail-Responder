...
app.get('/', async (req, res) => {
  ...
  async function fetchUnrepliesMessages(auth) {
    console.log('Showing UnrepliesMessages')
    const gmail = google.gmail({ version: 'v1', auth })
  ...
  async function main() {
    ...
    setInterval(async () => {
      const messages = await fetchUnrepliesMessages(auth)
...
app.listen(5010, () => {
  console.log(`server is running 5010`)
})
